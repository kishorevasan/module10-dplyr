...
print(vehicles[order(vehicles$hwy[vehicles$year==1997]),])
...
testfun <- function(year,make){
  return(vehicles[vehicles$hwy == max(vehicles$hwy[vehicles$make == make & vehicles$year==year]),])
}

vehicles[vehicles$hwy == max(vehicles$hwy[vehicles$make == "Honda" & vehicles$year==1995]) & vehicles$year==1995,]

# What was the most efficient honda model of 1995?
print(testfun("Honda",1995))
